...
<body style="direction: rtl;">
  ...
  <div class="popular_causes_area section_padding" style="background-color: #ffffff;">
    <div class="container">
      ...
      <div class="row mb-5">
        <div class="col-12">
          <div class="card shadow-sm" style="border-radius: 15px; border: none; background: linear-gradient(135deg, #ffffff 0%, #f9f9f9 100%);">
            <div class="card-body p-4" style="direction: rtl;">
              <form method="GET" action="{{ route('web_volunteers') }}" class="row g-3 align-items-end">
                <div class="col-md-4">
