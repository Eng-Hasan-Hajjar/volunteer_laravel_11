...
<body style="direction: rtl;">
  ...
  <div class="popular_causes_area section_padding" style="background: linear-gradient(135deg, #f5f7fa 0%, #ffffff 100%);">
    <div class="container">
      ...
      <!-- بطاقة البحث والفلتر الاحترافية -->
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="single_cause" style="background-color: #f9f9f9; border: 1px solid #e0e0e0; border-radius: 10px; overflow: hidden; transition: transform 0.3s ease, box-shadow 0.3s ease; position: relative; text-align: right;">
            ...
            <div class="causes_content" style="padding: 20px;">
              ...
              <p style="color: #333333; text-align: right;"><strong style="color: #0053c0;">البريد الإلكتروني:</strong> {{ $volunteer->person->email ?? 'غير محدد' }}</p>
              <p style="color: #333333; text-align: right;"><strong style="color: #0053c0;">رقم التواصل:</strong> {{ $volunteer->person->contact_number ?? 'غير محدد' }}</p>
              <p style="color: #333333; text-align: right;"><strong style="color: #0053c0;">الرقم القومي:</strong> {{ $volunteer->person->national_number ?? 'غير محدد' }}</p>
              <a href="{{ route('web_volunteers_single', $volunteer->id) }}" class="read_more" style="background: linear-gradient(90deg, #0053c0 0%, #1e90ff 100%); color: #ffffff; padding: 8px 20px; border-radius: 5px; text-decoration: none; display: inline-block; transition: background-color 0.3s ease; text-align: center;">عرض التفاصيل</a>
            </div>
          </div>
        </div>
        @empty
        <div class="col-12 text-center">
          <p class="text-muted">لا يوجد متطوعون متاحون بناءً على الفلاتر.</p>
        </div>
        @endforelse
      </div>
    </div>
