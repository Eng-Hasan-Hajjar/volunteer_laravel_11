...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="text-right">تعديل الشخص</h1>
            </div>
            <div class="col-sm-6">
...
<section class="content" dir="rtl" style="text-align: right;float:center">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary card-outline shadow-sm">
                    <div class="card-header">
                        <h3 class="card-title text-right">تحديث بيانات الشخص</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('people.update', $person->id) }}" method="POST" dir="rtl">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-6">
