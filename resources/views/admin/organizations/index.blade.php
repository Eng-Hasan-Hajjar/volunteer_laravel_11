...
<div class="content-wrapper" dir="rtl">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">المنظمات</h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    <div class="card card-primary card-outline w-100">
                        <div class="card-header" dir="rtl" style="display: flex; justify-content: space-between; align-items: center;">
                            <h3 class="card-title">قائمة المنظمات</h3>
                            <div class="card-tools">
                                <form action="{{ route('organizations.index') }}" method="GET" class="input-group input-group-sm" style="width: 250px;">
                                    <input type="text" name="search" class="form-control float-right" placeholder="بحث باسم المنظمة..." value="{{ request('search') }}">
                        ...
                        <div class="card-body p-0">
                            ...
                            <table class="table table-hover table-bordered table-striped text-right m-0">
                                <thead>
                                    <tr>
                                        <th style="width: 30%">اسم المنظمة</th>
                                ...
                                <tbody>
                                    @forelse ($organizations as $organization)
                                        <tr>
                                            ...
                                            <td>{{ \Carbon\Carbon::parse($organization->time_of_creation)->format('d-m-Y') }}</td>
                                            <td>
                                                <div class="btn-group">
                                                    <a href="{{ route('organizations.edit', $organization) }}" class="btn btn-sm btn-primary">
                                                        <i class="fas fa-edit"></i> تعديل
                                                    </a>
                                                    <form action="{{ route('organizations.destroy', $organization) }}" method="POST" style="display:inline;" class="ml-1">
                                                        @csrf
                                                        @method('DELETE')
